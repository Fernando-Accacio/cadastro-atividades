...
from collections import defaultdict # NOVO: Ferramenta útil para agrupar dados
...
def init_routes(app):
    ...
    def get_projects():
        ...
        # NOVO: Lógica para agrupar os projetos por área do saber
    ...
    # ... O restante do arquivo (get_ranked_projects, vote_project, etc.) continua igual ...
