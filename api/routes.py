...
# =========================================================
# === DECORADOR: VERIFICA O TOKEN DE LOGIN (Sem mudanças) ===
# =========================================================
...
def init_routes(app):
    ...
    # --- Rotas Protegidas (COM MUDANÇAS) ---

    # =========================================================
    # === ATUALIZAÇÃO: ROTA 'add_project' =====================
    # =========================================================
    ...
    def add_project():
        ...
        try:
            image_url_to_save = None # Começa como None
            
            # 1. Checa se um ARQUIVO foi enviado
            #    (Note: 'image_file' vem do React)
            ...
            # 2. Se nenhum ARQUIVO veio, checa se uma URL (texto) veio
            #    (Note: 'image_url' vem do React)
            elif 'image_url' in data and data.get('image_url'):
                image_url_to_save = data.get('image_url')

            # 3. Cria o novo projeto
            new_project = Project(
                name=data.get('name'),
                description=data.get('description', ''), 
                area_saber=data.get('area_saber'),
                materia=data.get('materia'),
                image_url=image_url_to_save, # <-- Salva a URL (do Cloudinary ou do input de texto)
    ...
    # =========================================================
    # === ATUALIZAÇÃO: ROTA 'update_project' ==================
    # =========================================================
    ...
    # =========================================================
    # === O RESTO DAS ROTAS (Sem mudanças) ==================
    # =========================================================
